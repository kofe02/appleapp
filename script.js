...
const questions = [
    {
        question: "どんな味のリンゴが好き？",
        options: { A: "とにかく甘いのが好き！", B: "甘さの中に酸味もほしい" },
        type: { A: 'S', B: 'R' } // Sweet / Rich acid
    },
    {
        question: "どんな歯ごたえが好き？",
        options: { A: "シャキッ！と爽快な食感", B: "サクッ、ほろりとした柔らかめ" },
        type: { A: 'C', B: 'M' } // Crispy / Mellow
    },
    {
        question: "香りはどれくらい大事？",
        options: { A: "豊かな香りも楽しみたい", B: "香りより味や食感が大事" },
        type: { A: 'A', B: 'F' } // Aromatic / Flavor
    },
    {
        question: "どうやって食べるのが好き？",
        options: { A: "やっぱり生でそのまま！", B: "アップルパイやジャムで楽しみたい" },
        type: { A: 'R', B: 'C' } // Raw / Cook
    }
];
...
const results = {
    ...
    'RCFC': { name: '紅玉（こうぎょく）', description: '「お菓子作りなら紅玉」と言われるほどの代表品種。その酸味が砂糖の甘さと完璧にマッチします。', eatingStyle: 'アップルパイ、焼きリンゴ、ジャムなど、どんなお菓子にも変身できます！', eatingStyle: 'アップルパイ、焼きリンゴ、ジャムなど、どんなお菓子にも変身できます！', image: 'https://placehold.co/200x200/B22222/FFFFFF?text=紅玉' },
...
function showQuestion() {
    ...
    optionBtns[0].innerText = currentQuestion.options.A;
    optionBtns[1].innerText = currentQuestion.options.B;
    updateProgressBar();
}
